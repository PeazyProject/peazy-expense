...
@CrossOrigin
@RestController
@RequestMapping(path = "/expenseCommon", produces = MediaType.APPLICATION_JSON_VALUE)
public class CommonController {
    ...
    public ResponseEntity<List<DropDownBean>> getDropDownList(@PathVariable String mainCategory,
            @PathVariable String subCategory) throws JsonProcessingException {

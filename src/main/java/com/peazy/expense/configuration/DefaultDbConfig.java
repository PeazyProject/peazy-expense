package com.peazy.expense.configuration;
...
public class DefaultDbConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.peazy.expense.model.entity").persistenceUnit("defaultDb")
				.build();
	}
